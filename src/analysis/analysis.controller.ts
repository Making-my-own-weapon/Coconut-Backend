...
import {
  RealtimeAnalysisRequestDto,
  RealtimeAnalysisResponseDto,
} from './dto/realtime-analysis.dto';
import {
  DetailedAnalysisRequestDto,
  DetailedAnalysisResponseDto,
} from './dto/detailed-analysis.dto';
...
export class AnalysisController {
  ...
  async getRealtimeAnalysis(
    ...
    return this.analysisService.getRealtimeAnalysis(
      dto.problemId,
      dto.studentCode,
    );
  }
